package com.nineclient.validate;

public class WccLotteryActivityValidate {
	...
	public String toString() {
		return "WccLotteryActivityValidate [startTimes=" + startTimes
				+ ", endTimes=" + endTimes + ", startTime=" + startTime
				+ ", endTime=" + endTime + ", oneName=" + oneName
				+ ", oneNumber=" + oneNumber + ", oneProbability="
				+ oneProbability + ", oneAwardInfo=" + oneAwardInfo
				+ ", twoName=" + twoName + ", twoNumber=" + twoNumber
				+ ", twoProbability=" + twoProbability + ", twoAwardInfo="
				+ twoAwardInfo + ", threeName=" + threeName + ", threeNumber="
				+ threeNumber + ", threeProbability=" + threeProbability
				+ ", threeAwardInfo=" + threeAwardInfo + ", fourName="
				+ fourName + ", fourNumber=" + fourNumber
