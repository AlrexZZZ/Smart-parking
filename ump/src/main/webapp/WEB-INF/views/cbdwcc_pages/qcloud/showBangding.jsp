...
<body>
	...
	<header id="header" class="mui-bar mui-bar-nav">
		<h1 class="mui-title">XXX11X大学</h1>
	...
	<div class="content">
		<section class="xueqi">
			<div class="class">
				<label id="classResult">信息绑定</label>
			</div>
		</section>
		<section class="enroll">
			...
			<form id="saveFormDataId" action="/ump/pageBding/saveBding" class="mui-input-group">
					...
					<label>openId：</label>
					<input type="text" name="openId" value="${openId}" id="openId_" />
				</div>
				...
				<div class="mui-input-row">
					<label>院系：</label>
					<input type="text" name="stuColleage" id="stuColleageId" class="mui-input-clear" placeholder="请输入您的系别" data-input-clear="5"><span class="mui-icon mui-icon-clear mui-hidden"></span>
				</div>
