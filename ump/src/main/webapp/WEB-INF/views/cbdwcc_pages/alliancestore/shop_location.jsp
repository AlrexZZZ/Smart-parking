...
<body>
    <div class="container"><!--container-->
      ...
      <div class="detail_map" id="detail_map1"><!--百度地图放置区-->
        <!--<img src="images/map_02.png" alt="">-->
      </div><!--百度地图放置区 end-->         
     <div class="detail_img">
      <div class="detail_article">
		${wccAlliancestore.storeIntro }
      </div> 
     </div>
...
map.centerAndZoom(new BMap.Point(${wccAlliancestore.storeLng},${wccAlliancestore.storeLat}),11);
var local = new BMap.LocalSearch(map, {
  renderOptions:{map: map, autoViewport:true}
})
//加载地图标注
var marker1 = new BMap.Marker(new BMap.Point(${wccAlliancestore.storeLng},${wccAlliancestore.storeLat}));
// 将标注添加到地图中
map.addOverlay(marker1);
local.searchNearby(${wccAlliancestore.storeAddress}, "斗门区");
</script>   
