...
<body>
	<sf:form enctype="multipart/form-data" modelAttribute="wccMaterials" method="post" action="../updateone" id="materForm">
		<sf:hidden path="id"/>
			...
			<div class="middle_menu">
				...
				<div class="ch_weixinpt">
					<div class="middle_search_lr">
						...
						公众平台: 
				        <!-- <select id="select1" class="SlectBox"> 
						</select>-->
						<sf:select path="wccPlatformUsers" items="${plats}" itemValue="id"></sf:select>
					</div>
				</div>
			</div>
			...
			<div class="editor_con">
				<div class="editor_L">
					<div class="editor_L_dandiv">
						<div class="editor_L_dandiv_tit" id="formTitle">${wccMaterials.title}</div>
						<div class="build_L_dandiv_img" id="cover"><img width="265px" src='${wccMaterials.thumbnailUrl}' /></div>
						<div class="editor_L_dandiv_zaiyao" id="formDesc">${wccMaterials.description}</div>
					</div>
				</div>
						...
						<div class="dtw_r_r">
							<div class="dtwrrform">
									...
									<div class="form_wenben">
										<input type="text" name="title" id="title" oninput="inputChange('title','formTitle');" value="${wccMaterials.title}"><div
									...
									<div class="form_wenben">
										<input type="text" name="token" value="${wccMaterials.token}">
									</div>
									<div class="form_tit">
									...
									<div class="sctu">
										<div class="form_wenben_tk">
											<input name="thumbnailUrl" type="hidden" id="url" value="${wccMaterials.thumbnailUrl}"/> 
									...
									<div class="form_wenben">
										<textarea name="description" id="description" oninput="inputChange('description','formDesc');">${wccMaterials.description}</textarea>
									...
									<div class="form_wenben" id="editor_z" style="width: 99%;">
										<textarea id="editor_id" name="content" style="width:300px;height:200px;">${wccMaterials.content}</textarea>
									</div>
									<div class="form_tit">
									...
									<div class="form_wenben" id="ywlj2">
										<select id="urlSelect" name="sort" style="width: 135px;" onchange="changeUrlSelect();">
											...
											<!-- <option value="3">预约活动</option> -->
											<option value="4">活动管理</option>
										</select>
										<input type="text" name="remakeUrl" id="remakeUrl" style="width: 69%;" value="${wccMaterials.remakeUrl}">
									</div>
